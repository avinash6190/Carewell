...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("custpay_ds"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class custpay_ds
    Inherits Global.System.Data.DataSet
    
    Private tableCompanydetails As CompanydetailsDataTable
    
    Private tablecust_pay As cust_payDataTable
    ...
    Protected Sub New(ByVal info As Global.System.Runtime.Serialization.SerializationInfo, ByVal context As Global.System.Runtime.Serialization.StreamingContext)
        ...
        If (Me.DetermineSchemaSerializationMode(info, context) = Global.System.Data.SchemaSerializationMode.IncludeSchema) Then
            ...
            End If
            If (Not (ds.Tables("cust_pay")) Is Nothing) Then
                MyBase.Tables.Add(New cust_payDataTable(ds.Tables("cust_pay")))
            End If
    ...
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
     Global.System.ComponentModel.Browsable(false),  _
     Global.System.ComponentModel.DesignerSerializationVisibility(Global.System.ComponentModel.DesignerSerializationVisibility.Content)>  _
    Public ReadOnly Property cust_pay() As cust_payDataTable
        Get
            Return Me.tablecust_pay
        End Get
    End Property
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As custpay_ds = CType(MyBase.Clone,custpay_ds)
        cln.InitVars
    ...
    Friend Overloads Sub InitVars(ByVal initTable As Boolean)
        ...
        If (initTable = true) Then
            ...
            End If
        End If
        Me.tablecust_pay = CType(MyBase.Tables("cust_pay"),cust_payDataTable)
        If (initTable = true) Then
            If (Not (Me.tablecust_pay) Is Nothing) Then
                Me.tablecust_pay.InitVars
            End If
        End If
    End Sub
    ...
    Private Sub InitClass()
        Me.DataSetName = "custpay_ds"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/custpay_ds.xsd"
        Me.EnforceConstraints = true
        Me.SchemaSerializationMode = Global.System.Data.SchemaSerializationMode.IncludeSchema
        Me.tableCompanydetails = New CompanydetailsDataTable
        MyBase.Tables.Add(Me.tableCompanydetails)
        Me.tablecust_pay = New cust_payDataTable
        MyBase.Tables.Add(Me.tablecust_pay)
    End Sub
    ...
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
    Private Function ShouldSerializecust_pay() As Boolean
        Return false
    End Function
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As custpay_ds = New custpay_ds
    ...
    Public Delegate Sub cust_payRowChangeEventHandler(ByVal sender As Object, ByVal e As cust_payRowChangeEvent)
    ...
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
     Global.System.Serializable(),  _
     Global.System.Xml.Serialization.XmlSchemaProviderAttribute("GetTypedTableSchema")>  _
    Partial Public Class cust_payDataTable
        Inherits Global.System.Data.DataTable
        Implements Global.System.Collections.IEnumerable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Default ReadOnly Property Item(ByVal index As Integer) As cust_payRow
            Get
                Return CType(Me.Rows(index),cust_payRow)
            End Get
        End Property
        
        Public Event cust_payRowChanging As cust_payRowChangeEventHandler
        
        Public Event cust_payRowChanged As cust_payRowChangeEventHandler
        
        Public Event cust_payRowDeleting As cust_payRowChangeEventHandler
        
        Public Event cust_payRowDeleted As cust_payRowChangeEventHandler
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Sub Addcust_payRow(ByVal row As cust_payRow)
            Me.Rows.Add(row)
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function Addcust_payRow(ByVal _date As String, ByVal billid As String, ByVal sales As Decimal, ByVal paid As Decimal, ByVal adjust As Decimal, ByVal balance As String, ByVal customer As String, ByVal mode As String, ByVal title As String, ByVal subtitle As String, ByVal sam As String, ByVal sample As String) As cust_payRow
            Dim rowcust_payRow As cust_payRow = CType(Me.NewRow,cust_payRow)
            Dim columnValuesArray() As Object = New Object() {_date, billid, sales, paid, adjust, balance, customer, mode, title, subtitle, sam, sample}
            rowcust_payRow.ItemArray = columnValuesArray
            Me.Rows.Add(rowcust_payRow)
            Return rowcust_payRow
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overrides Function Clone() As Global.System.Data.DataTable
            Dim cln As cust_payDataTable = CType(MyBase.Clone,cust_payDataTable)
            cln.InitVars
            Return cln
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.columnadjust = New Global.System.Data.DataColumn("adjust", GetType(Decimal), Nothing, Global.System.Data.MappingType.Element)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function Newcust_payRow() As cust_payRow
            Return CType(Me.NewRow,cust_payRow)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Protected Overrides Function NewRowFromBuilder(ByVal builder As Global.System.Data.DataRowBuilder) As Global.System.Data.DataRow
            Return New cust_payRow(builder)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Protected Overrides Function GetRowType() As Global.System.Type
            Return GetType(cust_payRow)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
            MyBase.OnRowChanged(e)
            If (Not (Me.cust_payRowChangedEvent) Is Nothing) Then
                RaiseEvent cust_payRowChanged(Me, New cust_payRowChangeEvent(CType(e.Row,cust_payRow), e.Action))
            End If
        End Sub
        ...
        Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
            MyBase.OnRowChanging(e)
            If (Not (Me.cust_payRowChangingEvent) Is Nothing) Then
                RaiseEvent cust_payRowChanging(Me, New cust_payRowChangeEvent(CType(e.Row,cust_payRow), e.Action))
            End If
        End Sub
        ...
        Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
            MyBase.OnRowDeleted(e)
            If (Not (Me.cust_payRowDeletedEvent) Is Nothing) Then
                RaiseEvent cust_payRowDeleted(Me, New cust_payRowChangeEvent(CType(e.Row,cust_payRow), e.Action))
            End If
        End Sub
        ...
        Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
            MyBase.OnRowDeleting(e)
            If (Not (Me.cust_payRowDeletingEvent) Is Nothing) Then
                RaiseEvent cust_payRowDeleting(Me, New cust_payRowChangeEvent(CType(e.Row,cust_payRow), e.Action))
            End If
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub Removecust_payRow(ByVal row As cust_payRow)
            Me.Rows.Remove(row)
        End Sub
        ...
        Public Shared Function GetTypedTableSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
            ...
            Dim attribute2 As Global.System.Xml.Schema.XmlSchemaAttribute = New Global.System.Xml.Schema.XmlSchemaAttribute
            attribute2.Name = "tableTypeName"
            attribute2.FixedValue = "cust_payDataTable"
            type.Attributes.Add(attribute2)
            type.Particle = sequence
            Dim dsSchema As Global.System.Xml.Schema.XmlSchema = ds.GetSchemaSerializable
            If xs.Contains(dsSchema.TargetNamespace) Then
    ...
    '''</summary>
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0")>  _
    Partial Public Class cust_payRow
        Inherits Global.System.Data.DataRow
        ...
        Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
            MyBase.New(rb)
            Me.tablecust_pay = CType(Me.Table,cust_payDataTable)
        End Sub
        ...
        Public Property _date() As String
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.dateColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'date' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.dateColumn) = value
            End Set
        End Property
        ...
        Public Property billid() As String
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.billidColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'billid' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.billidColumn) = value
            End Set
        End Property
        ...
        Public Property sales() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.salesColumn),Decimal)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'sales' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.salesColumn) = value
            End Set
        End Property
        ...
        Public Property paid() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.paidColumn),Decimal)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'paid' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.paidColumn) = value
            End Set
        End Property
        ...
        Public Property adjust() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.adjustColumn),Decimal)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'adjust' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.adjustColumn) = value
            End Set
        End Property
        ...
        Public Property balance() As String
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.balanceColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'balance' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.balanceColumn) = value
            End Set
        End Property
        ...
        Public Property customer() As String
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.customerColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'customer' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.customerColumn) = value
            End Set
        End Property
        ...
        Public Property mode() As String
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.modeColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'mode' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.modeColumn) = value
            End Set
        End Property
        ...
        Public Property title() As String
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.titleColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'title' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.titleColumn) = value
            End Set
        End Property
        ...
        Public Property subtitle() As String
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.subtitleColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'subtitle' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.subtitleColumn) = value
            End Set
        End Property
        ...
        Public Property sam() As String
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.samColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'sam' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.samColumn) = value
            End Set
        End Property
        ...
        Public Property sample() As String
            Get
                Try 
                    Return CType(Me(Me.tablecust_pay.sampleColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'sample' in table 'cust_pay' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecust_pay.sampleColumn) = value
            End Set
        End Property
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function Is_dateNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.dateColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub Set_dateNull()
            Me(Me.tablecust_pay.dateColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsbillidNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.billidColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetbillidNull()
            Me(Me.tablecust_pay.billidColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IssalesNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.salesColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetsalesNull()
            Me(Me.tablecust_pay.salesColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IspaidNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.paidColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetpaidNull()
            Me(Me.tablecust_pay.paidColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsadjustNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.adjustColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetadjustNull()
            Me(Me.tablecust_pay.adjustColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsbalanceNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.balanceColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetbalanceNull()
            Me(Me.tablecust_pay.balanceColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IscustomerNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.customerColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetcustomerNull()
            Me(Me.tablecust_pay.customerColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsmodeNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.modeColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetmodeNull()
            Me(Me.tablecust_pay.modeColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IstitleNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.titleColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SettitleNull()
            Me(Me.tablecust_pay.titleColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IssubtitleNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.subtitleColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetsubtitleNull()
            Me(Me.tablecust_pay.subtitleColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IssamNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.samColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetsamNull()
            Me(Me.tablecust_pay.samColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IssampleNull() As Boolean
            Return Me.IsNull(Me.tablecust_pay.sampleColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetsampleNull()
            Me(Me.tablecust_pay.sampleColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    '''</summary>
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0")>  _
    Public Class cust_payRowChangeEvent
        Inherits Global.System.EventArgs
        
        Private eventRow As cust_payRow
        
        Private eventAction As Global.System.Data.DataRowAction
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub New(ByVal row As cust_payRow, ByVal action As Global.System.Data.DataRowAction)
            MyBase.New
            Me.eventRow = row
            Me.eventAction = action
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public ReadOnly Property Row() As cust_payRow
            Get
                Return Me.eventRow
            End Get
        End Property
