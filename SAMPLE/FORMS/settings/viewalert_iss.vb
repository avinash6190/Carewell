Public Class viewalert_iss
    ...
    Sub cheque()
        ...
        dt1 = Alert_PROC("", Date.Today.ToString("MM/d/yyyy"), "", "showalert-iss")
        gdt.Rows.Clear()
    ...
    Private Sub viewalert_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub viewalert_iss_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call cheque()
        Itemgrid.Focus()
    End Sub
    ...
    Private Sub Itemgrid_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Itemgrid.DoubleClick
        Try
            ...
            response = MsgBox("Are you sure for cheque Issued.", MsgBoxStyle.YesNo, "message")
            If (response = vbYes) Then
                ...
                dat = CDate(a)
                Alert_PROC(getdt.Rows(i)(5), dat.ToString("MM/d/yyyy"), getdt.Rows(i)(6), "update-iss")
                Dim dt1 As New DataTable
                dt1 = Alert_PROC("", Date.Today.ToString("MM/d/yyyy"), "", "showalert-iss")
