...
Public Class sales_reports
    ...
    Private Sub sales_reports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            L2.Visible = False
            l3.Visible = False
            VIEW = sales_report("", "", "", "", "", "All_Sales")
            sal_grid.DataSource = VIEW
            sal_grid.Columns(0).Width = 100
            sal_grid.Columns(1).Width = 100
            sal_grid.Columns(2).Width = 175
            sal_grid.Columns(3).Width = 75
            sal_grid.Columns(4).Width = 100
            count()
    ...
    Private Sub Reset_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Reset.Click
        Try
            sales_reports_Load(Nothing, Nothing)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
        ...
        Try
            If txt_sup.Text <> "" Then
                If cbk_type.Text = "PRODUCT WISE" Then
                    DT = sales_report("", txt_sup.Text + "%", "", "", "", "PRODUCT")
                    ...
                    End If
                ElseIf cbk_type.Text = "CUSTOMER WISE" Then
                    DT = sales_report("", txt_sup.Text + "%", "", "", "", "CUSTOMER")
                    If DT.Rows.Count <> 0 Then
                        GRID.DataSource = DT
                    ...
                    End If
                ElseIf cbk_type.Text = "BILLNO WISE" Then
                    DT = sales_report("", txt_sup.Text + "%", "", "", "", "BILLNO")
                    If DT.Rows.Count <> 0 Then
                        GRID.DataSource = DT
                        GRID.Visible = True
                        GRID.Columns(0).Width = 200
    ...
    Private Sub btn_exp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_exp.Click
        Try
            If cbk_type.Text = "DAY WISE" Then
                VIEW = sales_report("", "", fdate.Value.ToString("MM/dd/yyyy"), "", "", "DAY WISE")
                sal_grid.DataSource = VIEW
            ElseIf cbk_type.Text = "DATE WISE" Then
                VIEW = sales_report("", "", fdate.Value.ToString("MM/dd/yyyy"), tdate.Value.ToString("MM/dd/yyyy"), "", "DATE WISE")
                sal_grid.DataSource = VIEW
            ElseIf cbk_type.Text = "PRODUCT WISE" Then
                VIEW = sales_report(brand.Text, txt_sup.Text, "", "", "", "PRODUCT WISE")
                sal_grid.DataSource = VIEW
            ElseIf cbk_type.Text = "CUSTOMER WISE" Then
                VIEW = sales_report("", "", "", "", txt_sup.Text, "CUSTOMER WISE")
                sal_grid.DataSource = VIEW
            ElseIf cbk_type.Text = "BILLNO WISE" Then
                VIEW = sales_report("", "", "", "", txt_sup.Text, "BILLNO WISE")
                sal_grid.DataSource = VIEW
            End If
            sal_grid.Columns(0).Width = 100
            sal_grid.Columns(1).Width = 100
    ...
    Sub count()
        Try
            ...
            For i As Integer = 0 To sal_grid.Rows.Count - 1
                price += sal_grid.Rows(i).Cells(4).Value
            Next
    ...
    Private Sub print_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles print.Click
        Try
            ...
            Dim str As String
            Dim ex As String
            If sal_grid.RowCount = 0 Then
                MsgBox("No data Found", MsgBoxStyle.Information)
            Else
                cnt = sal_grid.DataSource
                Dim rep As String
                rep = MsgBox("Are you sure", MsgBoxStyle.YesNo)
                If rep = vbYes Then
                    If cbk_type.Text = "DAY WISE" Then
                        str = "Day Wise Sales Report"
                        ex = fdate.Value.ToString("dd/MM/yyyy")
                    ElseIf cbk_type.Text = "DATE WISE" Then
                        str = "Date Wise Sales Report"
                        ex = "From " + fdate.Value.ToString("dd/MM/yyyy") + " To " + tdate.Value.ToString("dd/MM/yyyy")
                    ElseIf cbk_type.Text = "PRODUCT WISE" Then
                        str = "Product Wise Sales Report"
                        ex = "Product Name " + txt_sup.Text
                    ElseIf cbk_type.Text = "CUSTOMER WISE" Then
                        str = "Customer Wise Sales Report"
                        ex = "Customer Name " + txt_sup.Text
                    ElseIf cbk_type.Text = "BILLNO WISE" Then
                        str = "Billno. Wise Sales Report"
                        ex = "Billno." + txt_sup.Text
                    Else
                        str = "Sales Report"
                        ex = ""
                    End If
                    Dim ds As New Sales_rpt
                    Dim da1 As New SqlDataAdapter
                    For i As Integer = 0 To cnt.Rows.Count - 1
                        ds.Tables("salesrpt").Rows.Add(cnt.Rows(i)(0), cnt.Rows(i)(1), cnt.Rows(i)(2), cnt.Rows(i)(3), 0, "", 0, 0, 0, 0, cnt.Rows(i)(4), str.ToString, ex.ToString, "")
                    Next
    ...
    Private Sub sal_grid_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sal_grid.DoubleClick
        Try
            Dim billno As String
            If sal_grid.RowCount <> 0 Then
                billno = sal_grid.CurrentRow.Cells(1).Value
                Dim sss As New Sales_Voucher(billno)
                sss.ShowDialog()
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
