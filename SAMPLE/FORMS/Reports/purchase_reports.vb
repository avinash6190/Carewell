...
Public Class purchase_reports
    ...
    Private Sub purchase_reports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            L2.Visible = False
            l3.Visible = False
            VIEW = REPORTS_PROC("", "", "", "", "", "All_Purchase")
            pur_grid.DataSource = VIEW
            pur_grid.Columns(0).Width = 100
            pur_grid.Columns(1).Width = 100
            pur_grid.Columns(2).Width = 100
            pur_grid.Columns(3).Width = 175
    ...
    Private Sub Reset_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Reset.Click
        Try
            purchase_reports_Load(Nothing, Nothing)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
        ...
        Try
            If txt_sup.Text <> "" Then
                If cbk_type.Text = "PRODUCT WISE" Then
                    DT = REPORTS_PROC("", txt_sup.Text + "%", "", "", "", "PRODUCT")
                    ...
                    End If
                ElseIf cbk_type.Text = "SUPPLIER WISE" Then
                    DT = REPORTS_PROC("", txt_sup.Text + "%", "", "", "", "SUPPLIER")
                    If DT.Rows.Count <> 0 Then
                        GRID.DataSource = DT
                    ...
                    End If
                ElseIf cbk_type.Text = "BILLNO WISE" Then
                    DT = REPORTS_PROC("", txt_sup.Text + "%", "", "", "", "BILLNO")
                    If DT.Rows.Count <> 0 Then
                        GRID.DataSource = DT
                        GRID.Visible = True
                        GRID.Columns(0).Width = 200
    ...
    Private Sub btn_exp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_exp.Click
        Try
            If cbk_type.Text = "DAY WISE" Then
                VIEW = REPORTS_PROC("", "", fdate.Value.ToString("MM/dd/yyyy"), "", "", "DAY WISE")
                pur_grid.DataSource = VIEW
            ElseIf cbk_type.Text = "DATE WISE" Then
                VIEW = REPORTS_PROC("", "", fdate.Value.ToString("MM/dd/yyyy"), tdate.Value.ToString("MM/dd/yyyy"), "", "DATE WISE")
                pur_grid.DataSource = VIEW
            ElseIf cbk_type.Text = "PRODUCT WISE" Then
                VIEW = REPORTS_PROC(brand.Text, txt_sup.Text, "", "", "", "PRODUCT WISE")
                pur_grid.DataSource = VIEW
            ElseIf cbk_type.Text = "SUPPLIER WISE" Then
                VIEW = REPORTS_PROC("", "", "", "", txt_sup.Text, "SUPPLIER WISE")
                pur_grid.DataSource = VIEW
            ElseIf cbk_type.Text = "BILLNO WISE" Then
                VIEW = REPORTS_PROC("", "", "", "", txt_sup.Text, "BILLNO WISE")
                pur_grid.DataSource = VIEW
            End If
            pur_grid.Columns(0).Width = 100
            pur_grid.Columns(1).Width = 100
    ...
    Sub count()
        Try
            ...
            For i As Integer = 0 To pur_grid.Rows.Count - 1
                price += pur_grid.Rows(i).Cells(5).Value
            Next
    ...
    Private Sub print_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles print.Click
        Try
            ...
            Else
                ...
                If rep = vbYes Then
                    If cbk_type.Text = "DAY WISE" Then
                        str = "Day Wise Purchase Report"
                        ex = fdate.Value.ToString("dd/MM/yyyy")
                    ElseIf cbk_type.Text = "DATE WISE" Then
                        str = "Date Wise Purchase Report"
                        ex = "From " + fdate.Value.ToString("dd/MM/yyyy") + " To " + tdate.Value.ToString("dd/MM/yyyy")
                    ElseIf cbk_type.Text = "PRODUCT WISE" Then
                        str = "Product Wise Purchase Report"
                        ex = "Product Name " + txt_sup.Text
                    ElseIf cbk_type.Text = "SUPPLIER WISE" Then
                        ex = "Supplier Name " + txt_sup.Text
                        str = "Supplier Wise Purchase Report"
                    ElseIf cbk_type.Text = "BILLNO WISE" Then
                        ex = "Billno." + txt_sup.Text
                        str = "Billno. Wise Purchase Report"
                    Else
                        str = "Purchase Report"
                        ex = ""
                    End If
                    Dim ds As New purchase_rpt
                    Dim da1 As New SqlDataAdapter
                    For i As Integer = 0 To cnt.Rows.Count - 1
                        ds.Tables("pur_rpt").Rows.Add(cnt.Rows(i)(0), cnt.Rows(i)(1), cnt.Rows(i)(2), cnt.Rows(i)(4), 0, cnt.Rows(i)(3), 0, "", 0, 0, 0, 0, cnt.Rows(i)(5), str.ToString, ex.ToString, "")
                    Next
    ...
    Private Sub pur_grid_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pur_grid.DoubleClick
        Try
            If pur_grid.RowCount <> 0 Then
                ...
                billno = pur_grid.CurrentRow.Cells(2).Value
                Dim sss As New purchase(billno)
                sss.ShowDialog()
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
